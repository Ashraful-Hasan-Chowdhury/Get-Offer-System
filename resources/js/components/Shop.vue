<template>
  <div class="container-fluid">
    <center><h5 class="m-0 mt-3 font-weight-bold text-info"><i class="fa fa-map-marker" aria-hidden="true"></i> Your Location: 
          ...
          <div class="col-md-8 offset-2">
                <div class="card">
                      <div class="card-header py-3 ">
                        <h5 class="m-0 font-weight-bold text-dark">Mark a Place to Find Shops</h5>
                      </div>
        ...
        <div class="row">
            ...
            <div class="card-header py-3 ">
              <h5 class="m-0 font-weight-bold text-dark">Nearest Shops</h5>
            </div>
            <div class="card-body">
              <br>
...
export default {
  ...
  methods: {
    ...
    getResults(page = 1) {
      axios.post('show-shop?page='+page,{
                    lat:this.center.lat,
                    lng:this.center.lng
                })
        .then(response => {
    ...
    viewDetails(placeid){
        axios.get('details-shop/'+placeid)
                .then(response => { 
