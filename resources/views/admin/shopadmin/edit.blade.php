            ...
            @endif
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group" >
                    <label for="exampleInputEmail1">Shop Documents Image</label>
                    <center>
                      <img src="{{ asset($profile->shop_doc) }}" alt="no image found" style="width: 300px;height: 200px;">
                    </center>
                  </div>
                  

                   <a href="{{ route('approve.shopadmin',$profile->id) }}" class="btn btn-md btn-success">Approve</a>
